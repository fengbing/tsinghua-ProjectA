...
namespace Gley.UrbanSystem.Internal
{
    ...
    public class Path
    {
        ...
        public Path(Vector3 startPosition, Vector3 startTangent, Vector3 endPosition, Vector3 endTangent)
        {
            ...
            {
                startPosition,
                startPosition + startTangent.normalized * (distance / 2f),
                endPosition - endTangent.normalized * (distance / 2f),
                endPosition
            };
        }
