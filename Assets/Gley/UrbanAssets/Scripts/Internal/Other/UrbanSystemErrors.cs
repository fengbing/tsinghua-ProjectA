namespace Gley.UrbanSystem.Internal
{
    public static class UrbanSystemErrors
    {
        ...
        public static string EmptyScene => "The scene seems empty. Please add some geometry inside the scene before setting up anything or add some ground/road layers.";
