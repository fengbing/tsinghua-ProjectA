...
using UrbanSystemErrors = Gley.UrbanSystem.Internal.UrbanSystemErrors;
using RowData = Gley.UrbanSystem.Internal.RowData;
using CellData = Gley.UrbanSystem.Internal.CellData;
using CellProperties = Gley.UrbanSystem.Internal.CellProperties;
using CellWaypointsData = Gley.UrbanSystem.Internal.CellWaypointsData;
using SpawnWaypoint = Gley.UrbanSystem.Internal.SpawnWaypoint;
...
namespace Gley.UrbanSystem.Editor
{
    internal class GridCreator
    {
        ...
        internal void GenerateGrid(int gridCellSize, LayerMask roadLayers)
        {
