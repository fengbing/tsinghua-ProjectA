...
namespace Gley.UrbanSystem.Editor
{
    public abstract class GridSetupWindowBase : SetupWindowBase
    {
        ...
        void RegenerateGrid()
        {
            ...
            var trafficLayers = FileCreator.LoadOrCreateLayers<TrafficSystem.Internal.LayerSetup>(TrafficSystem.TrafficSystemConstants.layerPath);
            ...
            var pedestrianLayers = FileCreator.LoadOrCreateLayers<PedestrianSystem.Internal.LayerSetup>(PedestrianSystem.Internal.PedestrianSystemConstants.LayerPath);
