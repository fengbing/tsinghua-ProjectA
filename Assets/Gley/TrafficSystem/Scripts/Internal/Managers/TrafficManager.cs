...
using PathFindingData = Gley.UrbanSystem.Internal.PathFindingData;
using IPedestrianWaypointsDataHandler = Gley.UrbanSystem.Internal.IPedestrianWaypointsDataHandler;
using CoroutineManager = Gley.UrbanSystem.Internal.CoroutineManager;
...
namespace Gley.TrafficSystem.Internal
{
    ...
    internal class TrafficManager : MonoBehaviour
    {
        ...
        private void OnDestroy()
        {
            ...
            UrbanSystem.Internal.DestroyableManager.Instance.DestroyAll();
        }
        #endregion
