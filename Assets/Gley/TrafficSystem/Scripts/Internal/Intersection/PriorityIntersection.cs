...
using IPedestrianWaypointsDataHandler = Gley.UrbanSystem.Internal.IPedestrianWaypointsDataHandler;
using DestroyableManager = Gley.UrbanSystem.Internal.DestroyableManager;
using IIntersection = Gley.UrbanSystem.Internal.IIntersection;
...
namespace Gley.TrafficSystem.Internal
{
    ...
    /// </summary>
    public class PriorityIntersection : GenericIntersection, UrbanSystem.Internal.IDestroyable
    {
