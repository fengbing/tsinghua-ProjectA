...
using VisibilityScript = Gley.UrbanSystem.Internal.VisibilityScript;
using IVehicleLightsComponent = Gley.UrbanSystem.Internal.IVehicleLightsComponent;
using VehicleLightsComponent = Gley.UrbanSystem.Internal.VehicleLightsComponent;
