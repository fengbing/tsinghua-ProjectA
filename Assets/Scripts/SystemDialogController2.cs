...
/// <summary>
/// <see cref="SystemDialogController"/> 的完整副本，供第二关等场景单独调参；默认使用独立 Overlay 画布名避免与原版冲突。
/// </summary>
public class SystemDialogController2 : MonoBehaviour, ISystemDialogPresentation
{
    const string DedicatedCanvasName = "SystemDialogCanvas2";
