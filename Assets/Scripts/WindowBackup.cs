...
public class WindowBackup : MonoBehaviour
{
    ...
    {
        Debug.Log("[WindowBackup] QuitGame called — 退出游戏");
#if UNITY_EDITOR
    ...
    void BindButtons()
    {
        if (continueButton != null)
        {
            ...
            Debug.LogWarning("[WindowBackup] continueButton 未赋值");
        ...
        if (menu2Button != null)
        {
            ...
            Debug.LogWarning("[WindowBackup] menu2Button 未赋值");
        ...
        if (quitButton != null)
        {
            ...
            Debug.LogWarning("[WindowBackup] quitButton 未赋值");
    }
    ...
    void SetupRaycast()
    {
        ...
        if (canvas == null)
        {
            Debug.LogWarning("[WindowBackup] 未找到 Canvas！");
            return;
        }
